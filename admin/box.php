...
<div class="row">
	...
	require $arrIni['base'].'lib/data/box/dBox.php'; 
		...
		function buscar(vId, vPag, vVar, vStr) {
			if (vId=="grill")
			{
				if (vVar=="pagina") {
					$.ajax({
					   type: "GET",
					   url: "http://<?php echo $_SERVER['SERVER_NAME'];?>/lib/data/box/dBox.php",
			...
			} else if (vId=="buttons")
			{
				$.ajax({
				   type: "GET",
				   url: "http://<?php echo $_SERVER['SERVER_NAME'];?>/lib/data/box/dBox.actions.php",
			...
			} else if (vId=="actions")
			{
				$.ajax({
				   type: "GET",
				   url: "http://<?php echo $_SERVER['SERVER_NAME'];?>/lib/data/box/dBox.actions.e.php",
