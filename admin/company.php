...
<div class="row">
    ...
    </h2>Administrate Companies</h2><p>
    </div>
</div>
<!-- TABLA -->
<div class="row">
	...
	require $arrIni['base'].'lib/data/company/dCompany.php'; 
		...
		function buscar(vId, vPag, vVar, vStr) {
			if (vId=="grill")
			{
				if (vVar=="pagina") {
					$.ajax({
					   type: "GET",
					   url: "http://<?php echo $_SERVER['SERVER_NAME'];?>/lib/data/company/dCompany.php",
			...
			} else if (vId=="buttons")
			{
				$.ajax({
				   type: "GET",
				   url: "http://<?php echo $_SERVER['SERVER_NAME'];?>/lib/data/company/dCompany.actions.php",
			...
			} else if (vId=="actions")
			{
				$.ajax({
				   type: "GET",
				   url: "http://<?php echo $_SERVER['SERVER_NAME'];?>/lib/data/company/dCompany.actions.e.php",
