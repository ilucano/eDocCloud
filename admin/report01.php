...
<div class="row">
    ...
    </h2>Report 01: Boxes grouped by Status</h2><p>
    </div>
</div>
<!-- TABLA -->
<div class="row">
	...
	require $arrIni['base'].'lib/data/dReport01.php'; 
		...
		function buscar(vId, vPag, vVar) {
			if (vId=="grill")
			{
				if (vVar=="pagina") {
					$.ajax({
					   type: "GET",
					   url: "http://www.edoccloud.com/lib/data/dInproc.php",
					   data: "pagAct="+vPag,
			...
			} else if (vId=="action")
			{
				$.ajax({
				   type: "GET",
				   url: "http://www.edoccloud.com/lib/data/wf.inproc.php",
