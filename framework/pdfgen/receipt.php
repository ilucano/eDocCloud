...
function fact_dev( $libelle, $num )
{
    ...
    $texte  = $libelle . " N" . iconv("UTF-8", "ISO-8859-1", '°') . " : " . $num;    
    $szfont = 12;
    $loop   = 0;
...
function addDevis( $numdev )
{
    ...
    $this->fact_dev( "Order Pickup", $string );
}
...
function addCadreEurosFrancs()
{
    ...
    $this->SetXY( $r1, $y1+10 );
    $this->Cell(20,4, "CREDITS", 0, 0, "C");
    $this->SetXY( $r1, $y1+15 );
    $this->Cell(20,4, "TO PAY", 0, 0, "C");
}
...
function temporaire( $texte )
{
    ...
    $this->Rotate(45,45,230);
    $this->Text(25,230,$texte);
    $this->Rotate(0);
