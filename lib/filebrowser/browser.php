...
function dropDownYearButton($row_id, $file_year)
{
	...
	$drop_down_list = '<ul style="height: 250px; overflow:auto;" id="drop'.$row_id.'" data-dropdown-content class="f-dropdown" aria-hidden="true" tabindex="-1">'.$drop_down_list.'</ul>';
